function [ret]=colormap2gmt(CMAP_USE,GMT_RANGE,FILEOUT,NANCOLOR);
...
OUT = [range_ref(1:end-1),CMAP_GMT(1:end-1,:),range_ref(2:end),CMAP_GMT(1:end-1,:)];
